...
map_name=region_name+"_2size_test_start"+".html"
m.save(map_name) 
...
def test_node_group_cost():
    ...
    for i in range(len(final_decision_zone_list)):
        ...
        filename = "cost_cs_hanover_1size_almost_exact.csv"
        cur_df.to_csv(filename)   
test_node_group_cost() 

    
cs_cost_read=pd.read_csv ('cost_cs_hanover_1size_almost_exact.csv')
...
for i in range(1,13):
    ...
    df_obj.to_csv("evaluation_costs_1size_almost_exact_"+str(demand_limit)+".csv")
